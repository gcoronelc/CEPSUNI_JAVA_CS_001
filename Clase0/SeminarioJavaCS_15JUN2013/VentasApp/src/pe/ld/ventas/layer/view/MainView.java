...
public class MainView extends javax.swing.JFrame {
	...
	private void mnuRepoCatalogoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuRepoCatalogoActionPerformed
		try {
			...
			JasperReport rep = JasperCompileManager.compileReport(MainView.class.getResourceAsStream("reports/repoCatalogo.jrxml"));
	...
	/**
	 * Este método se encarga de agregar todos los JInternalFrame al panel (destopPane).
	 */
